...
@class KVAMeasurement_AdAttribution_Conversion;
/// A feature which interfaces with Apple’s AdAttribution system.
SWIFT_CLASS_NAMED("AdAttribution")
@interface KVAMeasurement_AdAttribution : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// The current conversion information.
@property (nonatomic, strong) KVAMeasurement_AdAttribution_Conversion * _Nonnull conversion;
@end

@interface KVAMeasurement_AdAttribution (SWIFT_EXTENSION(KochavaMeasurement))
@end

@class KVAMeasurement_AdAttribution_Conversion_Result;
@class KVAMeasurement_AdAttribution_Conversion_Result_API;
/// A feature which determines ad attribution conversion(s).
SWIFT_CLASS_NAMED("Conversion")
@interface KVAMeasurement_AdAttribution_Conversion : NSObject
/// A closure which is called when the AdAttribution updatePostbackConversionValue API has been called.
...
@property (nonatomic, copy) void (^ _Nullable closure_didUpdatePostbackValue)(KVAMeasurement_AdAttribution_Conversion * _Nonnull, KVAMeasurement_AdAttribution_Conversion_Result * _Nonnull, KVAMeasurement_AdAttribution_Conversion_Result_API * _Nonnull);
...
@property (nonatomic, strong) KVAMeasurement_AdAttribution_Conversion_Result * _Nonnull result;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface KVAMeasurement_AdAttribution_Conversion (SWIFT_EXTENSION(KochavaMeasurement))
@end
...
@class NSString;
@class NSNumber;
/// The ad attribution conversion result.
SWIFT_CLASS_NAMED("Result")
@interface KVAMeasurement_AdAttribution_Conversion_Result : NSObject <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
+ (nullable instancetype)kva_from:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (id _Nullable)kva_toContext:(KVAContext * _Nullable)context SWIFT_WARN_UNUSED_RESULT;
/// Return the conversion value integer which is used with the AdAttributionKit and SKAdNetwork conversion value update APIs.
...
@property (nonatomic, readonly) NSError * _Nullable aakError;
@property (nonatomic, readonly) NSError * _Nullable skanError;
...
/// The coarse value.
@property (nonatomic, readonly) SKAdNetworkCoarseConversionValue _Nullable skanCoarseValue SWIFT_AVAILABILITY(ios_app_extension,introduced=16.1) SWIFT_AVAILABILITY(ios,introduced=16.1);
@property (nonatomic, readonly, strong) NSNumber * _Nullable translatedValueIntNumber;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("API")
@interface KVAMeasurement_AdAttribution_Conversion_Result_API : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// \param identifier The identifier.  An identifier of nil will remove any existing identifier under the specified name.
///
/// \param registrarArray An array of RegistrarProvider to which to register the custom identifier.
///
...
/// \param value The value.  Must be a String or NSNumber (which includes NSDecimalNumber, Int, Double, and Bool).  A value of nil will remove any existing value under the specified name.
///
/// \param registrarArray An array of RegistrarProvider to which to register the custom value.
///
...
SWIFT_PROTOCOL_NAMED("RegistrarProvider")
@protocol KVACustomValue_RegistrarProvider
/// A property which conforms to protocol CustomValue.Registrar.
...
SWIFT_PROTOCOL_NAMED("Processor")
...
SWIFT_PROTOCOL_NAMED("ProcessorProvider")
@protocol KVADeeplink_ProcessorProvider
/// A property which conforms to protocol Processor.
...
@protocol KVADeeplink_DeferredPrefetch_AugmenterProvider;
...
/// \param identifier The identifier.  An identifier of nil will remove any existing identifier under the specified name.
///
/// \param augmenterArray An array of Deeplink_DeferredPrefetch_AugmenterProvider to which to augment the deferred prefetch.
///
+ (void)augmentWithName:(NSString * _Nonnull)name identifier:(NSString * _Nullable)identifier augmenterArray:(NSArray<id <KVADeeplink_DeferredPrefetch_AugmenterProvider>> * _Nullable)augmenterArray;
...
/// \param domain A domain to associate with the deeplink wrapper.
///
/// \param registrarArray An array of RegistrarProvider to which to register the deeplink wrapper.
///
...
SWIFT_PROTOCOL_NAMED("Deeplink_DeferredPrefetch_Augmenter")
@protocol KVADeeplink_DeferredPrefetch_Augmenter
- (void)augment:(KVADeeplink_DeferredPrefetch * _Nonnull)deferredPrefetch;
@end

SWIFT_PROTOCOL_NAMED("Deeplink_DeferredPrefetch_AugmenterProvider")
@protocol KVADeeplink_DeferredPrefetch_AugmenterProvider
/// A property which conforms to protocol Deeplink_DeferredPrefetch_Augmenter.
@property (nonatomic, readonly, strong) id <KVADeeplink_DeferredPrefetch_Augmenter> _Nonnull deeplinks_deferredPrefetch_augmenter;
@end
...
/// Send the event using the default SenderProvider.
/// The default is the shared instance of class <code>Measurement</code>.
- (void)send;
/// Send the event with a specified array of SenderProvider(s).
...
/// When serviced locally the response for the request is provided locally and the request is post the event to the server is never made.  In every other respect the effects are the same.  AdAttribution conversion information is still calculated.
...
@property (nonatomic, strong) KVANetworking_Privacy_IntelligentConsent * _Nullable consent;
...
SWIFT_PROTOCOL_NAMED("SenderProvider")
@protocol KVAEvent_SenderProvider
/// A property which conforms to protocol Sender.
...
/// \param userIdString The value.  A value of nil will remove any existing value under the user_id name.
///
/// \param registrarArray An array of RegistrarProvider to which to register the event default parameter.
///
...
/// \param eventName A string containing the custom event name.
///
/// \param senderArray Optional.  An array of senders.  These are objects which conform to protocol SenderProvider.  If this parameter is not passed the default sender will be used.  The default sender is the shared instance of class Measurement, which if you are using you may simply your call by using the function of the same name which omits this parameter.
///
...
/// \param identifier The identifier.  An identifier of nil will remove any existing identifier under the specified name.
///
/// \param registrarArray An array of RegistrarProvider to which to register the identity link.
///
...
@interface KVAMeasurement : NSObject <KVADeeplink_DeferredPrefetch_AugmenterProvider, KVACustomIdentifier_RegistrarProvider, KVACustomValue_RegistrarProvider, KVADeeplink_ProcessorProvider, KVAEvent_SenderProvider, KVAIdentityLink_RegistrarProvider, KVAPrivacyProfile_RegistrarProvider, KVADeeplink_Wrapper_RegistrarProvider, KVAEvent_DefaultParameter_RegistrarProvider>
...
/// A feature which interfaces with Apple’s AdAttributionKit system.
/// <h1>See</h1>
/// Class <code>Measurement/AdAttribution</code>.
@property (nonatomic, readonly, strong) KVAMeasurement_AdAttribution * _Nonnull adAttribution;
...
///
- (void)authorizationDidCompleteWithStatus:(ATTrackingManagerAuthorizationStatus)status;
/// An instance of networking.
@property (nonatomic, strong) KVANetworking * _Nullable networking;
